...
$imb = 0.05
$bits = 32
$weights = "model_cb_CLRS_if0.05_bits32.pth"
$tag = "model_cb_CLRS_if0.05_bits32"
...
Write-Host "[Train] CLRS class_balanced (1-beta) (if=0.05, bits=32)" -ForegroundColor Cyan
...
Write-Host "[Test ] CLRS class_balanced (1-beta) (if=0.05, bits=32)" -ForegroundColor Green
...
Write-Host "Done: class_balanced 1-beta case finished." -ForegroundColor Magenta
